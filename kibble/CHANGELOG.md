...
- Follow upstream to `kibble-api`/`kibble-web` **0.25.2** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.25.2))

## 0.25.1

- Follow upstream to `kibble-api`/`kibble-web` **0.25.1** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.25.1))

## 0.24.0

- Follow upstream to `kibble-api`/`kibble-web` **0.24.0** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.24.0))

## 0.23.0

- Follow upstream to `kibble-api`/`kibble-web` **0.23.0** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.23.0))

## 0.22.0

- Follow upstream to `kibble-api`/`kibble-web` **0.22.0** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.22.0))

## 0.21.2

- Follow upstream to `kibble-api`/`kibble-web` **0.21.2** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.21.2))
- Base image `21.0.4` → **`21.0.5`**

## 0.20.0

- Follow upstream to `kibble-api`/`kibble-web` **0.20.0** ([release notes](https://github.com/eigger/kibble/releases/tag/v0.20.0))
